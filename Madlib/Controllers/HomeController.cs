...
namespace Madlib.Controllers
{
  public class HomeController : Controller
  {
    ...
    [Route("/madlibTwo")]
    public ActionResult MadlibTwo(string firstWord, string secondWord, string thirdWord, string fourthWord, string fifthWord, string sixthWord, string seventhWord)
    {
      MadlibInputs myMadlibVariable = new MadlibInputs();
      myMadlibVariable.First = firstWord;
      myMadlibVariable.Second = secondWord;
